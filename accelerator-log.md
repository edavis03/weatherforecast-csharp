...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'tanzu_dotnet'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->tanzu-dotnet]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'tanzu-dotnet.csproj'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->tanzu_dotnet]
